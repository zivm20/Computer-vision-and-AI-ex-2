...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        loss = loss + np.sum((self.reg/2)*W1**2) + np.sum((self.reg/2)*W2**2)
        dx,grads['W2'],grads['b2']=affine_backward(dx,cache[1])
        dx,grads['W1'],grads['b1']=affine_relu_backward(dx,cache[0])
